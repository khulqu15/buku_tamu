                    ...
                    <div class="col-md-10 offset-md-1 mt-5 pb-5">
                        ...
                        <div class="mt-5 p-3 bg-white position-relative">
                            <div class="d-flex mb-3">
                                ...
                                <h4 class="font-weight-bold pt-1 ml-3">FORM PENCARIAN PEMINJAMAN BARANG</h4>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-10 pt-3">
                                    <div class="form-group">
                                        <label for="search">Cari barang yang akan dipinjam</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text bg-white" id="view"><i class="fa fa-search" aria-hidden="true"></i></div>
                                            </div>
                                            <input type="text" name="search" id="search" class="form-control border-left-0" placeholder="Cari berdasarkan nama">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="col-md-12 mt-4 text-center">
                                ...
                                <a class="btn btn-success w-50" href="{{ url('/pengembalian') }}" role="button">Pengembalian</a>
                            </div>
                        </div>
                    </div>
                    </div>
