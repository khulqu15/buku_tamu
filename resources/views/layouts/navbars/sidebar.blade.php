            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('pegawai') }}">
                        <i class="ni ni-circle-08"></i> List Pegawai
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('siswa') }}">
                        <i class="ni ni-circle-08"></i> List Siswa
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('tamu') }}">
                        <i class="ni ni-circle-08"></i> List Tamu
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('barang') }}">
                        <i class="ni ni-single-copy-04"></i> List Barang
                    </a>
                </li>
                <li class="nav-item">
