                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input type="date" value="{{ $from }}" name="from_date" id="from_date" class="form-control" placeholder="Dari tanggal">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="input-group input-group-sm mb-3">
                                                    <input type="date" value="{{ $to }}" name="to_date" id="to_date" class="form-control" placeholder="Sampai Tanggal">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-4 mt-4 text-right">
                                    <div class="form-group">
                                        <div class="input-group input-group-sm mb-3">
                                            <input type="text" name="search" id="search" value="{{ $query }}" class="form-control" placeholder="Cari tamu...">
