...
@section('content')
<div class="container-fluid py-5 bg-image-home overflow-hidden position-relative" style="height:100vh;display: flex; align-items: center;">
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2 mt-2">
                <div class="login-card">
                    <div class="position-relative bg-light p-4" style="z-index: 10">
                        <div class="position-relative text-center">
                            <img src="{{ URL::asset('img/assets/img/logo.png') }}" width="150px" alt="">
                            ...
                            <div class="text-left mt-5">
                                <form action="{{ url('/login/post') }}" method="POST">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="px-5 py-3 mt-3 mb-3 w-50 btn btn-danger">Masuk</button>
                                    </div>
                                </form>
                            </div>
                        </div>
